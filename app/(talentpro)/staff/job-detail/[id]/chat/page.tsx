...
const ChatPage = () => {
  ...
  return (
    <div className="flex flex-col h-[100dvh]">
      {/* Header */}
      <div
        className=" sticky top-0 md:top-3 p-2 flex cursor-pointer items-center space-x-2"
        onClick={() => {
          handleClickBack();
        }}
      >
      ...
      {/* Message Input */}
      {(chatStatus === "open" || assignedToMe === true) &&
      ...
      {chatStatus === "closed" && (
        <div className="flex flex-row items-center justify-center gap-4 p-4">
          ...
          <p className="text-[12px] font-[400] leading-[18px]">
            For smoother experience, please wait for the client to respond to
            continue the chat.
          </p>
        </div>
      )}
