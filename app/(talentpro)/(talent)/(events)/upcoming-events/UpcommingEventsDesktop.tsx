                  ...
                  {event.has_offered ? (
                    ...
                    <div
                      onClick={() => {
                        ...
                        router.push(
                          `/staff/job-detail/${event.id}?returnUrl=/upcoming-events`
                        );
                      }}
                    ...
                    >
                      <p className="flex items-center justify-center text-center text-[#350ABC] font-[500] text-[18px] leading-[24px]">
                        {loadingButton.eventId === event.id &&
                        loadingButton.type === "viewOffer" ? (
                  ...
                  {event.has_offered && (
                    <div
                      onClick={() => {
                        ...
                        router.push(
                          `/staff/job-detail/${event.invite_id}/chat?returnUrl=/upcoming-events`
                        );
                      }}
                    ...
                    >
                      <p className="flex items-center justify-center text-center text-white font-[500] text-[18px] leading-[24px]">
                        {loadingButton.eventId === event.id &&
                        loadingButton.type === "talkToClient" ? (
                          <Loader2 className="w-5 h-5 animate-spin" />
                        ) : (
                          "Talk to Client"
                        )}
