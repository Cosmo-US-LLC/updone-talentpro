...
const OfferMobile = ({
  ...
  useEffect(() => {
    const fetchEvents = async () => {
      try {
        ...
        setEventCount(
          eventsData.filter((event: any) => event.has_offered === true).length
        );
      } catch (error) {
  ...
  return (
    <div className="">
      {events?.length === 0 ||
        (!events?.some((event: any) => event.has_offered === true) && (
      ...
      {events?.length > 0 &&
        events
          .filter((event: any) => event.has_offered === true)
          .map((event: any, id: any) => {
            ...
            return (
              <div
                key={id}
                className="shadow-md rounded-md flex flex-col items-start justify-start mt-4 bg-[white] border border-1 border-[#EBE6FF] pl-[16px] pt-[16px] pb-[12px]"
              >
                <div className="flex flex-row items-center justify-between flex-wrap">
                  <div className="mr-2 flex-shrink-0">
                    <Image
                      src={
                        serviceIcons[
                          event.service_name as keyof typeof serviceIcons
                  ...
                  <div className=" flex-grow min-w-0 mr-20">
                    <h3 className="text-[12px] ">Requested Service</h3>
                ...
                <div className="pt-4">
                  <p className="text-start text-[18px] font-bold">
                    {truncatedTitle}
                  </p>
                  {event.title.length > MAX_TITLE_LENGTH && (
                    <button
                ...
                <div className="mt-3">
                  <div className="flex flex-row">
                    ...
                    <div className="flex flex-col flex-grow">
                      <h3 className="text-[12px] ">Date</h3>
                      <p className="text-[14px] font-semibold">
                ...
                <div className="mt-3">
                  <div className="flex flex-row">
                    ...
                    <div className="flex flex-col flex-grow">
                      <h3 className="text-[12px]">Time</h3>
                      <p className="text-[14px] font-semibold">
                ...
                <div className="flex flex-row w-full items-start justify-end mt-1 ">
                  <div
                    onClick={() => {
                      const url = `/staff/job-detail/${event.id}?returnUrl=/offered`;
                  ...
                  <div
                    onClick={() => {
                      const url = `/staff/job-detail/${event.invite_id}/chat?returnUrl=/offered`;
