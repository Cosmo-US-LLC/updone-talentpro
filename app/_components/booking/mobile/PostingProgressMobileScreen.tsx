...
import Congratulations from '../../(mobile-version)/drawer-screens/Congratulations';
import { CongratulationsDrawer } from '../../(mobile-version)/CongratulationsDrawer';

const PostingProgressMobileScreen = () => {
    ...
    const [openCongratulationsScreen, setOpenCongratulationsScreen] = useState(false);
    ...
    useEffect(() => {
        if (currentStep <= 2) {
            ...
            setOpenCongratulationsScreen(true);
    ...
    return (
        <div className="flex-grow overflow-y-auto flex flex-col items-start justify-center h-screen bg-gray-50">
            <img
                src={`/images/gallery/confirm-booking/progress_${currentStep ? currentStep : 1}.svg`}
                alt="Progress icon"
                className="w-[150px] h-[150px] right-4"
            />
            <div className='flex flex-col px-10'>
                <p className="text-[24px] leading-[21px] font-semibold mb-2 ">Job Posting in progress</p>
                <p className="text-gray-500 mb-8 ">Please wait while we are working on your job posting process</p>
            ...
            {
                openCongratulationsScreen === true &&
...
export default PostingProgressMobileScreen;
