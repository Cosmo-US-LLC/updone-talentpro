...
const ConfirmDetailsModalMobile = ({ setStep, modalIsOpen, setModalIsOpen, selectedTalents }: any) => {
            ...
            >
                <div className="p-10 bg-white rounded-lg shadow-lg">
                    <div className='flex items-center justify-between mb-6'>
                        <h2 className="text-[16px] font-medium underline leading-[32px]">Please Confirm Your Event Details</h2>
                        <Image className='cursor-pointer' src='/images/gallery/confirm-booking/x.svg' height={32} width={32} alt='x-icon' onClick={() => { setModalIsOpen(false) }} />
                    </div>

                    <div className="mb-8">
                        <div className='flex flex-row justify-between items-center'>
                            <div className='flex gap-2'>
                                <Image src='/images/gallery/confirm-booking/map-pin.svg' height={16} width={16} alt='map-icon' />
                                <h3 className="font-semibold text-[14px] leading-[24px]">Where will the event be held?</h3>
                            </div>
                            <Image
                        ...
                        <p className="text-[#6B6B6B] text-[14px] font-normal mt-1 leading-[24px]">{jobCreateState?.selectedLocation}</p>
                    </div>

                    <div className="mb-6">
                        <div className='flex flex-row justify-between items-center'>
                            <div className='flex gap-2'>
                                <Image src='/images/gallery/confirm-booking/required-service.svg' height={16} width={16} alt='required-service' />
                                <h3 className="font-semibold text-[14px] leading-[24px]">{jobCreateState?.title}</h3>
                            </div>
                            <Image
                                onClick={() => {
                                    setModalIsOpen(false);
                                ...
                                className='cursor-pointer' src='/images/gallery/confirm-booking/edit.svg' height={16} width={16} alt='edit-icon' />
                        </div>
                    ...
                    <div className="mb-6 items-center">
                        <div className='flex flex-row justify-between items-center gap-2 mb-2'>
                            <div className='flex gap-2'>
                                <Image src='/images/gallery/confirm-booking/briefcase.svg' height={16} width={16} alt='briefcase-icon' />
                                <h3 className="font-normal text-[14px] leading-[24px]">Requested Service:</h3>
                            </div>
                            <Image
                                onClick={() => {
                                    setModalIsOpen(false);
                        ...
                        <p className="text-[#6B6B6B] text-[14px] font-normal leading-[24px]">{jobCreateState?.selectedService.name}</p>
                    </div>

                    <div className="mb-6 bg-[#F6F9FC] p-4 rounded-lg">
                        <div className='flex gap-2 items-center justify-between mb-4'>
                            <h3 className="font-semibold text-[14px] leading-[24px]">Your selected event day and time are:</h3>
                            <Image
                                onClick={() => {
                                    setModalIsOpen(false);
                                    router.push('/add-job?step=service-details');
                        ...
                        <div className="flex items-center justify-between">
                            <div className="flex items-center">
                                <span className='mr-1'><Image src='/images/gallery/confirm-booking/calendar.svg' height={16} width={16} alt='calendar-icon' />
                                </span>
                                <span className='font-semibold text-[14px] leading-[24px]'>Date: </span>
                                <p className="font-normal text-[14px] text-[#6B6B6B] ml-2 leading-[24px]">{formattedEvent.date}</p>
                            </div>
                            <div className="flex items-center">
                                <span className='mr-1'><Image src='/images/gallery/confirm-booking/clock.svg' height={16} width={16} alt='clock-icon' /></span>
                                <span className='font-semibold text-[14px] leading-[24px]'>Time: </span>
                                <p className="font-normal text-[14px] text-[#6B6B6B] ml-2 leading-[24px]">{formattedEvent.time}</p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div className="mb-6">
                        <div className='flex flex-row items-center gap-2 mb-2'>
                            <Image src='/images/gallery/confirm-booking/user-plus.svg' height={16} width={16} alt='user-plus' />
                            <h3 className="font-semibold text-[14px] leading-[24px]">Invited Talent</h3>
                        </div>
                        <div className="flex items-center mt-2">
                            ...
                            <div
                                ...
                                className="cursor-pointer text-[#350ABC] text-[12px] leading-[20px] font-normal ml-4">+ add more</div>
                        </div>
                    </div>
                    ...
                    <hr className="my-6" style={{ borderColor: '#EBE6FF' }} />
                    <div className="flex justify-between items-center mt-6">
                        ...
                        <div className='flex gap-2'>
                            ...
                            <button className="w-[217px] h-[48px] bg-[#350ABC] text-white text-[14px] leading-[26px] font-normal rounded-md"
                                onClick={() => {
...
export default ConfirmDetailsModalMobile;
